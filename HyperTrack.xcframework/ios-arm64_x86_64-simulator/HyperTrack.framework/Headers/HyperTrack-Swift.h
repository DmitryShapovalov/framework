...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull startedTrackingNotification SWIFT_DEPRECATED_MSG("`HyperTrackStartedTracking` was deprecated.");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull stoppedTrackingNotification SWIFT_DEPRECATED_MSG("`HyperTrackStoppedTracking` was deprecated.");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull didEncounterRestorableErrorNotification SWIFT_DEPRECATED_MSG("`HyperTrackDidEncounterRestorableError` was deprecated.");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull didEncounterUnrestorableErrorNotification SWIFT_DEPRECATED_MSG("`HyperTrackDidEncounterUnrestorableError` was deprecated.");)
